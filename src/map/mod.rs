...
///
/// default is VecAnyData::Data(AnyData::None)
#[derive(Debug, Clone)]
pub enum VecAnyData {
    Data(AnyData),
    Vec(Vec<AnyData>),
...
impl VecAnyData {
    pub fn is_empty(&self) -> bool {
        match self {
            VecAnyData::Data(d) => matches!(d, AnyData::None),
            VecAnyData::Vec(v) => v.is_empty(),
        }
    }

    pub fn from_opt_any(oa: Option<AnyData>) -> Self {
        match oa {
            Some(a) => VecAnyData::Data(a),
            None => VecAnyData::default(),
        }
    }
}
impl Default for VecAnyData {
    fn default() -> Self {
        VecAnyData::Data(AnyData::None)
    }
}
...
pub struct MapParams {
    ...
    /// input data, generated by the siblings of the Mapper that run before this
    #[builder(default)]
