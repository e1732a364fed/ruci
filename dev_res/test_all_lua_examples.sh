...
test_lua_file() {
    ...
    # 运行命令
    RUST_LOG=none,ruci=debug cargo run --features "lua quinn lwip use-native-tls steganography" --example lua "../$file" &
    local pid=$!
...
RUST_LOG=none,ruci=debug cargo build --example lua --features "lua quinn lwip use-native-tls steganography"
